...
21.0.7. To build the distribution library NGSEPcore.jar on a unix based
command line environment run the following commands in the directory where
NGSEPcore_5.1.0.tar.gz is located:

tar -xzvf NGSEPcore_5.1.0.tar.gz
cd NGSEPcore_5.1.0
make all
...
cp NGSEPcore_5.1.0.jar NGSEPcore.jar

or just make a symbolic link:

ln -s NGSEPcore_5.1.0.jar NGSEPcore.jar
...
OPTIONS:
	...
	-mpl INT	: Minimum number of path edges to build a contig.
			  Default: 6
...
OPTIONS:
        ...
        -p INT		: Minimum percentage of k-mers to call orthologs.
        		  Default: 50
        -s		: Skip the MCL clustering phase and returns unfiltered
        		  orthogroups.
        -y INT		: Type of sequences in the input file. 1 for CDNA,
        		  2 for proteins. Default: 1
	-t INT		: Number of threads. Default: 1
...
Receives a file generated by the NGSEP transposons finder and calculates
statistics on number of events and span per family.

USAGE:

java -jar NGSEPcore.jar TransposonStats <OPTIONS>

OPTIONS:

        -i FILE : Input file with annotations of transposable elements
        -o FILE : Output file with statistics per family
