 ...
 *
 */
public class SuffixArrayGenerator2 {
	...
	/** the ranks array: Each value contains the position in the suffix array */
	private final byte[] ranks;

	/**
	 * create a new instance of the suffix array generator.
	 *
	 * @param data the sequence to which the suffix array is calculated
	 */
	public SuffixArrayGenerator2(byte[] data) {
		index = new ArrayDeque<>();
		indexAux = new ArrayDeque<>();
