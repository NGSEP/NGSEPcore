...
public class ProcessClusterVCFTask extends Thread {
	//Results
	private List<VCFRecord> generatedRecords = null;
	...
	//Params
	private double heterozygosityRate;
	private byte maxBaseQS;
	private short minQuality;
	private double minAlleleFrequency;
	
	//Check for counters
	private boolean hasCalledVariant = false;
	private boolean hasGenVariant = false;
	
	//Global counters
	private MutableInt calledVariantsCount;
	private MutableInt geneticVariantsCount;
	
	public ProcessClusterVCFTask(ReadCluster readCluster, VCFFileHeader vcfFileHeader, VCFFileWriter writer, MutableInt calledVariantsCount, MutableInt geneticVariantsCount, PrintStream outVariants, List<Sample> samples, double heterozygosityRate, byte maxBaseQS, short minQuality, double minAlleleFrequency) {
		...
		this.calledVariantsCount = calledVariantsCount;
		this.geneticVariantsCount = geneticVariantsCount;
	}
	
	/**
	 * Returns the records that were generated by the task
	 * @return
	 */
	...
	/**
	 * 
	 * @return true if the vcf for this cluster had a called variant
	 */
	public boolean hadCalledVariant() {
		return hasCalledVariant;
	}
	
	/**
	 * 
	 * @return true if the vcf for this cluster had a genetic variant
	 */
	public boolean hadGenVariant() {
		return hasGenVariant;
	}
	...
	public void run() {
		...
		synchronized (calledVariantsCount) {
			calledVariantsCount.value = calledVariantsCount.value + 1;
		}
		synchronized (geneticVariantsCount) {
			geneticVariantsCount.value = geneticVariantsCount.value + 1;
		}
